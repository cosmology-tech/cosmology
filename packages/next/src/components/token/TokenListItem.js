...
import { getCoinFromDenom } from 'dexmos';
...
const TokenListItem = ({
    ...
    return <div
        className={dropDownConfig ? 'token-list-item clickable' : 'token-list-item'}
        onMouseDown={dropDownConfig ? (e) => dropDownConfig.onMouseDown({ ...e, preventDefault: e.preventDefault, currentTarget: { value } }) : null}  //super hack to enable this element to be a div
