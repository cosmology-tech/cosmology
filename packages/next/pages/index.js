...
export default function Home() {
  ...
  return (
    <div className='backdrop'>
      ...
      <main className={styles.main} style={{ justifyContent: 'flex-start', paddingTop: 0 }}>
        <div style={{ width: '100%', padding: '8px 16px', display: 'flex', alignItems: 'center', paddingTop: 16 }}>
          <img src="/logo.svg" width={32} height={32} style={{ marginRight: 8 }}></img>
          <h4 style={{ fontFamily: 'Comfortaa' }}>dexmos</h4>
        </div>
        {/* <button onClick={() => handleTest()}>click me</button> */}


        <img src="/automateosmosis.png" style={{ maxWidth: 350, marginTop: 60, opacity: 0.5 }} />

        <h2 className='main-text paragraph' style={{ marginTop: 60 }}>Automating DeFi in the Cosmos.</h2>
        <p className='detail-text paragraph' >Automate your daily Osmosis rewards reinvestments with dexmos.finance</p>
        <button className='action-button' style={{fontWeight:300}} onClick={() => window.location.href = "/app"}>View Demo</button>
